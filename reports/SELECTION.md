...
Trong 50 dòng đứng đầu [outputs/selection_round1.csv](file:///C:/Users/Kien/Desktop/VinUni/Lab8/outputs/selection_round1.csv), nếu chỉ có ngân sách rà năm ảnh, tôi sẽ ưu tiên chọn 5 frame theo bảng sau:
...
1. **frame_0395.jpg** (Rank 1 trong CSV, score = 0.9150): Trên ảnh contact sheet [outputs/selection_round1.jpg](file:///C:/Users/Kien/Desktop/VinUni/Lab8/outputs/selection_round1.jpg), frame này có nhiều vệt xe buýt lớn và ô tô ở làn giữa chuyển động nhanh, nơi mô hình phân vân giữa xe tải/buýt và quầng sáng lóa.
